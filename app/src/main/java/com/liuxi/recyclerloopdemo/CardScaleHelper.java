...
public class CardScaleHelper {
    ...
    private PagerSnapScaleHelper mLinearSnapHelper = new PagerSnapScaleHelper();
...
//                    mLinearSnapHelper.setMNoNeedToScroll(mCurrentItemOffset == 0 || mCurrentItemOffset == getDestItemOffset(mRecyclerView.getAdapter().getItemCount() - 1));
//                } else {
//                    mLinearSnapHelper.setMNoNeedToScroll(false);
//                }
            }
    ...
    private void initWidth() {
        mRecyclerView.post(new Runnable() {
            ...
            public void run() {
                ...
                mCardWidth = mCardGalleryWidth - MainActivity.Companion.dip2px(mContext, 2 * (mPagePadding + mShowLeftCardWidth));
