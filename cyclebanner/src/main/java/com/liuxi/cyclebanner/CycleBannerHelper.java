 ...
 */
public class CycleBannerHelper {

    private CycleView mRecyclerView;
    private Context mContext;

    private float mScale = 0.8f; // 两边视图scale
    private int mPagePadding = CycleAdapterHelper.sPagePadding; // 卡片的padding, 卡片间的距离等于2倍的mPagePadding
    private int mShowLeftCardWidth = CycleAdapterHelper.sShowLeftCardWidth;   // 左边卡片显示大小
    ...
    public void attachToRecyclerView(final CycleView mRecyclerView) {
    ...
    private void initWidth() {
        mRecyclerView.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                ...
                mCardWidth = mCardGalleryWidth - CycleUtils.dip2px(mContext, 2 * (mPagePadding + mShowLeftCardWidth));
    ...
    public void scrollToPosition(int pos) {
        ...
        ((LinearLayoutManager) mRecyclerView.getLayoutManager()).
                scrollToPositionWithOffset(pos,
                        CycleUtils.dip2px(mContext, mPagePadding + mShowLeftCardWidth));
        mCurrentItemOffset = 0;
        mLastPos = pos;
        //认为是一次滑动停止 这里可以写滑动停止回调
     ...
     */
    private static class CardLinearSnapHelper extends PagerSnapHelper {
